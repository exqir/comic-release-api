 ...
 */
export interface GraphQLContext { req: Request, di: DependencyInjector }

/**
 * 
 */
export type GraphQLResolver<Source, Argument> = GraphQLFieldResolver<Source, GraphQLContext, Argument>
